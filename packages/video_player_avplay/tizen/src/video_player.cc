...
void VideoPlayer::SendSubtitleUpdate(int32_t duration, const std::string &text, flutter::EncodableList attributes, const std::vector<uint8_t>& picture,
                                    const double& picture_width, const double& picture_height) {
  flutter::EncodableMap result = {
      {flutter::EncodableValue("event"),
      ...
      {flutter::EncodableValue("pictureWidth"), flutter::EncodableValue(picture_width)},
      {flutter::EncodableValue("pictureHeight"), flutter::EncodableValue(picture_height)},
