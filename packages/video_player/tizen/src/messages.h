...
class AudioTracksMessage {
 public:
  // Constructs an object setting all fields.
  explicit AudioTracksMessage(const flutter::EncodableList& audio_tracks);
 ...
 private:
  static AudioTracksMessage FromEncodableList(const flutter::EncodableList& list);
  flutter::EncodableList ToEncodableList() const;
  friend class TizenVideoPlayerApi;
  friend class PigeonInternalCodecSerializer;
...
class AudioSelectTrackMessage {
 public:
  // Constructs an object setting all fields.
  explicit AudioSelectTrackMessage(
    int64_t texture_id,
 ...
 private:
  static AudioSelectTrackMessage FromEncodableList(const flutter::EncodableList& list);
  flutter::EncodableList ToEncodableList() const;
  friend class TizenVideoPlayerApi;
  friend class PigeonInternalCodecSerializer;
  int64_t texture_id_;
...
class TizenVideoPlayerApi {
 public:
  ...
  virtual ErrorOr<AudioTracksMessage> GetAudioTracks(const TextureMessage& msg) = 0;
  virtual std::optional<FlutterError> SelectAudioTrack(const AudioSelectTrackMessage& msg) = 0;
